...
---
A couple months ago, I was blagging on about logging libraries in nodejs. After pointing out how annoying it is to use logging libraries with 3rd party modules, I [declared that all modules should simply use `console.log()`](http://seanmonstar.com/2022/07/28/2013-07-25-console-log-all-the-things.html), and let applications hijack the console. Then, I looked around the npms, and couldn’t find an excellent example of a logging library that embraced that idea.
