...
title: Retainer
permalink: /retainer/
excerpt: A retainer funds your critical Rust dependencies, and gains direct access to the maintainer.
---
...
- [hyper][], the Rust HTTP implementation, and its dependencies
- [reqwest][], the batteries-included HTTP client
- [tower][], async services and middleware
- [Tokio][], the async runtime for Rust
- [bytes][], optimized bytes manipulation
- [Axum][], the recommended HTTP server framework
- [warp][], the functional server framework inspiring the others
- [tonic][], gRPC for Rust
...
To get one, contact me at [sean@seanmonstar.com](mailto:sean@seanmonstar.com).


[^fxa]: Some of them are even still in the cloud. Do you have a Firefox Account?
[^aws]: The role I filled at AWS is the same I now provide to everyone: maintaining the software teams need, meeting with them to help solve their problems.
